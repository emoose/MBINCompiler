...
{
    public class GcRealityIconTable : NMSTemplate       // size: 0x2F88
    {
        ...
        /* 0x1188 */ public TkTextureResource[] DiscoveryPageTradingIcons;

        [NMS(Size = 0x3, EnumValue = new string[3] { "Low", "Default", "High" })]
        /* 0x1524 */ public TkTextureResource[] DiscoveryPageConflictIcons;

        [NMS(Size = 0x7, EnumValue = new string[7] { "Traders", "Warriors", "Explorers", "Robots", "Atlas", "Diplomats", "None" })]
        /* 0x16B0 */ public TkTextureResource[] DiscoveryPageRaceIcons;

        /* 0x1A50 */ public List<GcPlanetResourceIconLookup> PlanetResourceIconLookups;
        ...
        /* 0x1A60 */ public TkTextureResource[] GameIcons;
    }
}
