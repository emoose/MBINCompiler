...
{
    [NMS(GUID = 0x5FD893487F22CDB1, NameHash = 0x9904F7D363A81377)]
    public class GcCharacterGlobals : NMSTemplate
    {
        ...
        /* 0x2C4 */ public float NPCCamoWipeEffectTime;
        /* 0x2C8 */ public float NPCCamoScanRevealTime;
        /* 0x2CC */ public float NPCMinStaticTurnAngle;
        /* 0x2D0 */ public float NPCFastStaticTurnAngle;
        /* 0x2D4 */ public float NPCSlowStaticTurnAngle;
        /* 0x2D8 */ public float NPCMaxStaticTurnSpeed;
        /* 0x2DC */ public float NPCActiveListenChance;
        /* 0x2E0 */ public float NPCLookAtThingChance;
        /* 0x2E4 */ public float NPCLookAtThingTimeMin;
        /* 0x2E8 */ public float NPCLookAtThingTimeMax;
        /* 0x2EC */ public float NPCLookAwayTimeMin;
        /* 0x2F0 */ public float NPCLookAwayTimeMax;
        /* 0x2F4 */ public float NPCMaxLookAtAngleMoving;
        /* 0x2F8 */ public float NPCMaxLookAtAngleStatic;
        /* 0x2FC */ public float NPCLookAtTerminateAngle;
        /* 0x300 */ public float NPCSeatedLookAtLateralReduction;
        /* 0x304 */ public float NPCMinInteractionSearchDist;
        /* 0x308 */ public float NPCMaxInteractionSearchDist;
        /* 0x30C */ public float NPCMaxFreighterInteractionSearchDist;
        /* 0x310 */ public float NPCMaxSettlementInteractionSearchDist;
        /* 0x314 */ public float NPCSteeringSpringTime;
        /* 0x318 */ public float NPCPerceptionRadius;
        /* 0x31C */ public float NPCSteeringObstacleAvoidStrength;
        /* 0x320 */ public float NPCSteeringFollowStrength;
        /* 0x324 */ public float NPCSteeringAvoidStrength;
        /* 0x328 */ public float NPCSteeringRadius;
        /* 0x32C */ public float NPCSteeringRepelDist;
        /* 0x330 */ public float NPCSteeringComingTowardsDegrees;
        /* 0x334 */ public float NPCSteeringCollisionAvoidAngle;
        /* 0x338 */ public float NPCSteeringCollisionAvoidStrength;
        /* 0x33C */ public float NPCSteeringRaySpread;
        /* 0x340 */ public float NPCSteeringRayLength;
        /* 0x344 */ public float NPCSteeringRaySphereSize;
        /* 0x348 */ public float NPCMaxRandomNavPathMinIndoorOffset;
        /* 0x34C */ public float NPCMaxRandomNavPathMaxIndoorOffset;
        /* 0x350 */ public float NPCMaxRandomNavPathMinOutdoorOffset;
        /* 0x354 */ public float NPCMaxRandomNavPathMaxOutdoorOffset;
        /* 0x358 */ public float NPCBlockedDestRadius;
        /* 0x35C */ public float NPCFlavourIdleTimeMin;
        /* 0x360 */ public float NPCFlavourIdleTimeMax;
        /* 0x364 */ public float NPCMoodIdleDelayChance;
        /* 0x368 */ public float NPCMoodIdleLowIntensityChance;
        /* 0x36C */ public float NPCReactToPlayerPresenceDist;
        /* 0x370 */ public float NPCReactToPlayerPresenceIndividualCooldown;
        /* 0x374 */ public float NPCReactToPlayerPresenceGloablCooldown;
        /* 0x378 */ public float NPCReactToPlayerPresenceStaticTimer;
        /* 0x37C */ public float NPCDisplayThoughtsMaxDuration;
        /* 0x380 */ public float NPCDisplayThoughtsMaxDistance;
        /* 0x384 */ public float NPCDisplayThoughtsRefreshInterval;
        /* 0x388 */ public float NPCDisplayThoughtsProbability;
        /* 0x38C */ public float NPCPOISelectionNearbyNPCBaseMultiplier;
    }
}
