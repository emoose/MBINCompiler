...
{
    [NMS(Size = 0x1370, GUID = 0x22B745F8A4A8433D, NameHash = 0xC45203411E9AFE95)]
    public class GcSpaceshipGlobals : NMSTemplate
    {
        ...
        /* 0x0DC4 */ public float NormalModeTakeOffCostMultiplier;
        /* 0x0DC8 */ public float SurvivalTakeOffCostMultiplier;
        /* 0x0DCC */ public float PlayerFreighterClearSpaceRadius;
        /* 0x0DD0 */ public float DriftSpring;
        /* 0x0DD4 */ public float DriftTurnStrengthMultiplier;
        /* 0x0DD8 */ public float DriftTurnBrakeMultiplier;
        /* 0x0DDC */ public float DirectionBrakeVRBoost;
        /* 0x0DE0 */ public float TurnRudderStrength;
        /* 0x0DE4 */ public float MuzzleLightIntensity;
        /* 0x0DE8 */ public float MuzzleAnimSpeed;
        /* 0x0DEC */ public TkHitCurveData MuzzleLightCurve;
        ...
        /* 0x01000 */ public float MiniWarpMinPlanetDistance;
        /* 0x01004 */ public float MiniWarpStoppingMarginStation;
        /* 0x01008 */ public float MiniWarpTrackingMargin;
        /* 0x0100C */ public float MiniWarpExitSpeed;
        /* 0x1010 */ public float MiniWarpExitSpeedStation;
        /* 0x1014 */ public float MiniWarpExitTime;
        /* 0x1018 */ public float MiniWarpHUDArrowAttractAngle;
        /* 0x101C */ public float MiniWarpHUDArrowAttractAngleStation;
        /* 0x1020 */ public float MiniWarpHUDArrowAttractAngleOtherPlayerStuff;
        /* 0x1024 */ public float MiniWarpHUDArrowAttractAngleSaveBeacon;
        /* 0x1028 */ public float MiniWarpHUDArrowAttractAngleDense;
        /* 0x102C */ public int MiniWarpHUDArrowNumMarkersToBeDense;
        /* 0x1030 */ public TkCurveType MiniWarpCurve;
        /* 0x1034 */ public float MiniWarpFlashIntensity;
        /* 0x1038 */ public float MiniWarpFlashDuration;
        /* 0x103C */ public float MiniWarpFlashDelay;
        /* 0x1040 */ public float MiniWarpNoAsteroidRadius;
        /* 0x1044 */ public float BoostNoAsteroidRadius;
        /* 0x1048 */ public float ShipHeatAlertTime;
        /* 0x104C */ public float LaserOverheatTime;
        /* 0x1050 */ public float LaserOverheatDownTime;
        /* 0x1054 */ public float LaserCoolFactor;
        /* 0x1058 */ public float LaserFireTime;
        /* 0x105C */ public float LaserWaitTime;
        /* 0x1060 */ public float ProjectileOverheatTime;
        /* 0x1064 */ public float ProjectileFireRate;
        /* 0x1068 */ public float ProjectileReloadTime;
        /* 0x106C */ public int ProjectileClipSize;
        /* 0x1070 */ public float SummonShipAnywhereHeightOffset;
        /* 0x1074 */ public float SummonShipAnywhereFwdOffset;
        /* 0x1078 */ public float SummonShipAnywhereRangeMax;
        /* 0x107C */ public float SummonShipAnywhereRangeMin;
        /* 0x1080 */ public float SummonShipHeightOffset;
        /* 0x1084 */ public float SummonShipApproachOffset;
        /* 0x1088 */ public float LandingHelperMinAngle;
        /* 0x108C */ public float LandingHelperTurnTime;
        /* 0x1090 */ public float LandingHelperRollTime;
        /* 0x1094 */ public float AnomalyStationMaxApproachSpeed;
        /* 0x1098 */ public float TakeOffSphereCastLength;
        /* 0x109C */ public float TakeOffSphereCastRadiusMul;
        /* 0x10A0 */ public float LandGroundTakeOffTime;
        /* 0x10A4 */ public float LandLookingForward;
        /* 0x10A8 */ public float LandHeightThreshold;
        /* 0x10AC */ public float LandWidthThreshold;
        /* 0x10B0 */ public float LandSlopeMax;
        /* 0x10B4 */ public float LandingAreaRadius;
        /* 0x10B8 */ public float LandingAreaFloorOffset;
        /* 0x10BC */ public float TargetLockTime;
        /* 0x10C0 */ public float TargetLockChangeTime;
        /* 0x10C4 */ public float TargetLockLoseTime;
        /* 0x10C8 */ public float BoostChargeRate;
        /* 0x10CC */ public float DamageMinHitTime;
        /* 0x10D0 */ public float DamageMaxHitTime;
        /* 0x10D4 */ public float DamageMinWoundTime;
        /* 0x10D8 */ public float SpaceBrakeMinAngularSpeed;
        /* 0x10DC */ public float SpaceBrakeAngularRange;
        /* 0x10E0 */ public float CollisionSpeedDamageAmount;
        /* 0x10E4 */ public float CollisionDeflectTime;
        /* 0x10E8 */ public float CollisionDeflectDamping;
        /* 0x10EC */ public float CollisionDeflectNormalFactor;
        /* 0x10F0 */ public float CollisionAsteroidDamp;
        /* 0x10F4 */ public float CollisionGroundDamp;
        /* 0x10F8 */ public float CollisionDistance;
        /* 0x10FC */ public float CollisionDistanceGround;
        /* 0x1100 */ public float CollisionDistanceAsteroid;
        /* 0x1104 */ public float CollisionDistanceAsteroidSide;
        /* 0x1108 */ public float CollisionDistanceSpaceships;
        /* 0x110C */ public float DeflectDistance;
        /* 0x1110 */ public float DeflectAlignTimeMin;
        /* 0x1114 */ public float DeflectAlignTimeMax;
        /* 0x1118 */ public TkCurveType DeflectCurve;
        /* 0x111C */ public float CollisionRadiusMultiplier;
        /* 0x1120 */ public float GroundHeightHardTimeMin;
        /* 0x1124 */ public float GroundHeightHardTimeMax;
        /* 0x1128 */ public float GroundHeightPostCollisionDamper;
        /* 0x112C */ public float GroundHeightSpeedLength;
        /* 0x1130 */ public float GroundHeightSpeedAngle;
        /* 0x1134 */ public float GroundHeightSpeedAngleRange;
        /* 0x1138 */ public int GroundHeightNumRays;
        /* 0x113C */ public float GroundHeightSmoothTime;
        /* 0x1140 */ public float LinearDamping;
        /* 0x1144 */ public float AngularDamping;
        /* 0x1148 */ public float DirectionDockingAngle;
        /* 0x114C */ public float DirectionDockTime;
        /* 0x1150 */ public float DirectionDockingInfoRange;
        /* 0x1154 */ public float LootAttractDistance;
        /* 0x1158 */ public float LootAttractTime;
        /* 0x115C */ public float LootDampForce;
        /* 0x1160 */ public float LootCollectDistance;
        /* 0x1164 */ public float GunOffset3rdPersonMultiplier;
        ...
        /* 0x1200 */ public float DockingRotateSpeed;
        /* 0x1204 */ public float DockingRotateSpeedVR;
        /* 0x1208 */ public float EjectAnimSwitchPoint;
        /* 0x120C */ public float EjectAnimSpeedFactor;
        /* 0x1210 */ public float ShipDifferentRepelRange;
        /* 0x1214 */ public float ShipDifferentRepelAmount;
        /* 0x1218 */ public float AtmosphereSpeed;
        /* 0x121C */ public float AtmosphereAngle;
        /* 0x1220 */ public float DroneAlignUpTime;
        /* 0x1224 */ public float DroneDustHeight;
        /* 0x1228 */ public float DroneMinHeight;
        /* 0x122C */ public float DroneHeightAdjust;
        /* 0x1230 */ public float FreighterSpeed;
        /* 0x1234 */ public float DroneWarpTime;
        /* 0x1238 */ public float DroneWarpMinForce;
        /* 0x123C */ public float DroneWarpMaxForce;
        /* 0x1240 */ public Vector3f CockpitScale;
        /* 0x1250 */ public float ShakePowerScaler;
        /* 0x1254 */ public float ShakeSpeed;
        /* 0x1258 */ public float ShakeMaxPower;
        /* 0x125C */ public float ShakeMaxSpeed;
        /* 0x1260 */ public float ShakeAlignBrake;
        /* 0x1264 */ public float WingmanAtTimeStart;
        /* 0x1268 */ public float WingmanAtTime;
        /* 0x126C */ public float WingmanAtTimeBack;
        /* 0x1270 */ public float WingmanPerpTime;
        /* 0x1274 */ public float WingmanAttackOffset;
        /* 0x1278 */ public float WingmanAttackRange;
        /* 0x127C */ public float WingmanAttackMinRange;
        /* 0x1280 */ public float WingmanAttackAngle;
        /* 0x1284 */ public float WingmanViewerAngle;
        /* 0x1288 */ public float WingmanAttackAimAngle;
        /* 0x128C */ public float WingmanAttackTime;
        /* 0x1290 */ public float WingmanAttackTimeout;
        /* 0x1294 */ public float WingmanAttackCoolTime;
        /* 0x1298 */ public float WingmanSpawnDist;
        /* 0x129C */ public float WingmanAlign;
        /* 0x12A0 */ public float WingmanAngle;
        /* 0x12A4 */ public float WingmanAngle2;
        /* 0x12A8 */ public float WingmanRadius;
        /* 0x12AC */ public float WingmanFwd1;
        /* 0x12B0 */ public float WingmanFwd2;
        /* 0x12B4 */ public float DronePlanetAttackRange;
        /* 0x12B8 */ public float DronePlanetAttackMinRange;
        /* 0x12BC */ public float DroneShootTime;
        /* 0x12C0 */ public float DroneAlertAngle;
        /* 0x12C4 */ public float DroneAlertRange;
        /* 0x12C8 */ public float DronePatrolRadius;
        /* 0x12CC */ public float DroneMoveArrivedRange;
        /* 0x12D0 */ public float DronePatrolTime;
        /* 0x12D4 */ public float ShipEnterRange;
        /* 0x12D8 */ public float ShipEnterAngle;
        /* 0x12DC */ public float ShipEnterTransitionTime;
        /* 0x12E0 */ public float ShipEnterSpeed;
        /* 0x12E4 */ public float ShipEnterMinTime;
        /* 0x12E8 */ public List<NMSString0x80> ShipModels;
        /* 0x12F8 */ public float HUDBoostUpgradeMultiplier;
        /* 0x12FC */ public float LaunchThrustersRegenTimePeriod;
        /* 0x1300 */ public float LaunchThrustersMinimumSummonPercentage;
        /* 0x1304 */ public float LaunchThrustersSummonCostMultiplier;
        /* 0x1308 */ public float SpeedUpDistanceThreshold;
        /* 0x130C */ public float SpeedUpDistanceFadeThreshold;
        /* 0x1310 */ public float SpeedUpVelocityThreshold;
        /* 0x1314 */ public float SpeedUpVelocityCoeff;
        /* 0x1318 */ public float MaxSpeedUpDistance;
        /* 0x131C */ public float MaxSpeedUpVelocity;
        /* 0x1320 */ public float StickLandThreshold;
        /* 0x1324 */ public float StickPulseThreshold;
        /* 0x1330 */ public Vector3f StickAnimationDamping;
        /* 0x1340 */ public float SpaceCombatFollowModeMaxTorque;
        /* 0x1344 */ public float SpaceCombatFollowModeAimTime;
        /* 0x1348 */ public float SpaceCombatFollowModeTargetDistance;
        /* 0x134C */ public float SpaceCombatFollowModeEvadeRoll;
        /* 0x1350 */ public float SpaceCombatFollowModeEvadeTime;
        /* 0x1354 */ public float SpaceCombatFollowModeBrakeBehindAngle;
        /* 0x1358 */ public float SpaceCombatFollowModeMaxBrakeBehind;
        /* 0x135C */ public float SpaceCombatFollowModeMaxBrakeHeadOn;
        /* 0x1360 */ public float SpaceCombatFollowModeEvadeThrust;
        /* 0x1364 */ public bool SpaceCombatFollowModeUseEvadeTarget;
        /* 0x1365 */ public bool SpaceCombatFollowModeUseBoost;
    }
}
