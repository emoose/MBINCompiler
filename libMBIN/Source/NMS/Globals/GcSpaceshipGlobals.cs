...
{
    [NMS(Size = 0x1360, GUID = 0x0C57D0C11D05D179, NameHash = 0xC45203411E9AFE95)]
    public class GcSpaceshipGlobals : NMSTemplate
    {
        ...
        /* 0x0FB4 */ public float FreighterApproachDistanceMin;
        /* 0x0FB8 */ public float FreighterApproachDistanceMax;
        /* 0x0FBC */ public float FreighterApproachSpeedDamper;
        /* 0x0FC0 */ public float FreighterApproachExtraMargin;
        /* 0x0FC4 */ public float MiniWarpShakeStrength;
        /* 0x0FC8 */ public float MiniWarpPlanetRadius;
        /* 0x0FCC */ public float MiniWarpStationRadius;
        /* 0x0FD0 */ public float MiniWarpFuelTime;
        /* 0x0FD4 */ public float MiniWarpAlignStrength;
        /* 0x0FD8 */ public float MiniWarpChargeTime;
        /* 0x0FDC */ public float MiniWarpSpeed;
        /* 0x0FE0 */ public float MiniWarpTopSpeedTime;
        /* 0x0FE4 */ public float MiniWarpTime;
        /* 0x0FE8 */ public float MiniWarpCooldownTime;
        /* 0x0FEC */ public float MiniWarpStoppingMarginPlanet;
        /* 0x0FF0 */ public float MiniWarpMinPlanetDistance;
        /* 0x0FF4 */ public float MiniWarpStoppingMarginStation;
        /* 0x0FF8 */ public float MiniWarpTrackingMargin;
        /* 0x0FFC */ public float MiniWarpExitSpeed;
        /* 0x1000 */ public float MiniWarpExitSpeedStation;
        /* 0x1004 */ public float MiniWarpExitTime;
        /* 0x1008 */ public float MiniWarpHUDArrowAttractAngle;
        /* 0x100C */ public float MiniWarpHUDArrowAttractAngleStation;
        /* 0x1010 */ public float MiniWarpHUDArrowAttractAngleOtherPlayerStuff;
        /* 0x1014 */ public float MiniWarpHUDArrowAttractAngleSaveBeacon;
        /* 0x1018 */ public float MiniWarpHUDArrowAttractAngleDense;
        /* 0x101C */ public int MiniWarpHUDArrowNumMarkersToBeDense;
        /* 0x1020 */ public TkCurveType MiniWarpCurve;
        /* 0x1024 */ public float MiniWarpFlashIntensity;
        /* 0x1028 */ public float MiniWarpFlashDuration;
        /* 0x102C */ public float MiniWarpFlashDelay;
        /* 0x1030 */ public float MiniWarpNoAsteroidRadius;
        /* 0x1034 */ public float BoostNoAsteroidRadius;
        /* 0x1038 */ public float ShipHeatAlertTime;
        /* 0x103C */ public float LaserOverheatTime;
        /* 0x1040 */ public float LaserOverheatDownTime;
        /* 0x1044 */ public float LaserCoolFactor;
        /* 0x1048 */ public float LaserFireTime;
        /* 0x104C */ public float LaserWaitTime;
        /* 0x1050 */ public float ProjectileOverheatTime;
        /* 0x1054 */ public float ProjectileFireRate;
        /* 0x1058 */ public float ProjectileReloadTime;
        /* 0x105C */ public int ProjectileClipSize;
        /* 0x1060 */ public float SummonShipAnywhereHeightOffset;
        /* 0x1064 */ public float SummonShipAnywhereFwdOffset;
        /* 0x1068 */ public float SummonShipAnywhereRangeMax;
        /* 0x106C */ public float SummonShipAnywhereRangeMin;
        /* 0x1070 */ public float SummonShipHeightOffset;
        /* 0x1074 */ public float SummonShipApproachOffset;
        /* 0x1078 */ public float LandingHelperMinAngle;
        /* 0x107C */ public float LandingHelperTurnTime;
        /* 0x1080 */ public float LandingHelperRollTime;
        /* 0x1084 */ public float AnomalyStationMaxApproachSpeed;
        /* 0x1088 */ public float TakeOffSphereCastLength;
        /* 0x108C */ public float TakeOffSphereCastRadiusMul;
        /* 0x1090 */ public float LandGroundTakeOffTime;
        /* 0x1094 */ public float LandLookingForward;
        /* 0x1098 */ public float LandHeightThreshold;
        /* 0x109C */ public float LandWidthThreshold;
        /* 0x10A0 */ public float LandSlopeMax;
        /* 0x10A4 */ public float LandingAreaRadius;
        /* 0x10A8 */ public float LandingAreaFloorOffset;
        /* 0x10AC */ public float TargetLockTime;
        /* 0x10B0 */ public float TargetLockChangeTime;
        /* 0x10B4 */ public float TargetLockLoseTime;
        /* 0x10B8 */ public float BoostChargeRate;
        /* 0x10BC */ public float DamageMinHitTime;
        /* 0x10C0 */ public float DamageMaxHitTime;
        /* 0x10C4 */ public float DamageMinWoundTime;
        /* 0x10C8 */ public float SpaceBrakeMinAngularSpeed;
        /* 0x10CC */ public float SpaceBrakeAngularRange;
        /* 0x10D0 */ public float CollisionSpeedDamageAmount;
        /* 0x10D4 */ public float CollisionDeflectTime;
        /* 0x10D8 */ public float CollisionDeflectDamping;
        /* 0x10DC */ public float CollisionDeflectNormalFactor;
        /* 0x10E0 */ public float CollisionAsteroidDamp;
        /* 0x10E4 */ public float CollisionGroundDamp;
        /* 0x10E8 */ public float CollisionDistance;
        /* 0x10EC */ public float CollisionDistanceGround;
        /* 0x10F0 */ public float CollisionDistanceAsteroid;
        /* 0x10F4 */ public float CollisionDistanceAsteroidSide;
        /* 0x10F8 */ public float CollisionDistanceSpaceships;
        /* 0x10FC */ public float DeflectDistance;
        /* 0x1100 */ public float DeflectAlignTimeMin;
        /* 0x1104 */ public float DeflectAlignTimeMax;
        /* 0x1108 */ public TkCurveType DeflectCurve;
        /* 0x110C */ public float CollisionRadiusMultiplier;
        /* 0x1110 */ public float GroundHeightHardTimeMin;
        /* 0x1114 */ public float GroundHeightHardTimeMax;
        /* 0x1118 */ public float GroundHeightPostCollisionDamper;
        /* 0x111C */ public float GroundHeightSpeedLength;
        /* 0x1120 */ public float GroundHeightSpeedAngle;
        /* 0x1124 */ public float GroundHeightSpeedAngleRange;
        /* 0x1128 */ public int GroundHeightNumRays;
        /* 0x112C */ public float GroundHeightSmoothTime;
        /* 0x1130 */ public float LinearDamping;
        /* 0x1134 */ public float AngularDamping;
        /* 0x1138 */ public float DirectionDockingAngle;
        /* 0x113C */ public float DirectionDockTime;
        /* 0x1140 */ public float DirectionDockingInfoRange;
        /* 0x1144 */ public float LootAttractDistance;
        /* 0x1148 */ public float LootAttractTime;
        /* 0x114C */ public float LootDampForce;
        /* 0x1150 */ public float LootCollectDistance;
        /* 0x1154 */ public float GunOffset3rdPersonMultiplier;
        /* 0x1160 */ public Vector3f GunOffsetLeft;
        /* 0x1170 */ public Vector3f GunOffsetRight;
        /* 0x1180 */ public Vector3f GunOffsetLeft2;
        /* 0x1190 */ public Vector3f GunOffsetRight2;
        /* 0x11A0 */ public Vector3f GunOffset3rdPersonLeft;
        /* 0x11B0 */ public Vector3f GunOffset3rdPersonRight;
        /* 0x11C0 */ public GcPlayerSpaceshipWarpData Warp;
        /* 0x11F0 */ public float DockingRotateSpeed;
        /* 0x11F4 */ public float DockingRotateSpeedVR;
        /* 0x11F8 */ public float EjectAnimSwitchPoint;
        /* 0x11FC */ public float EjectAnimSpeedFactor;
        /* 0x1200 */ public float ShipDifferentRepelRange;
        /* 0x1204 */ public float ShipDifferentRepelAmount;
        /* 0x1208 */ public float AtmosphereSpeed;
        /* 0x120C */ public float AtmosphereAngle;
        /* 0x1210 */ public float DroneAlignUpTime;
        /* 0x1214 */ public float DroneDustHeight;
        /* 0x1218 */ public float DroneMinHeight;
        /* 0x121C */ public float DroneHeightAdjust;
        /* 0x1220 */ public float FreighterSpeed;
        /* 0x1224 */ public float DroneWarpTime;
        /* 0x1228 */ public float DroneWarpMinForce;
        /* 0x122C */ public float DroneWarpMaxForce;
