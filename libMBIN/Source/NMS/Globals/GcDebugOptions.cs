...
{
    [NMS(Size = 0x25C8, GUID = 0xAB2831E34FFC773C, NameHash = 0x013FED27DF728C38)]
    public class GcDebugOptions : NMSTemplate
    {
        ...
        /* 0x1E5D */ public bool EnableSynergy;
        /* 0x1E5E */ public NMSString0x20 SynergyServer;
        /* 0x1E80 */ public int SynergyPort;
        /* 0x1E84 */ public bool ShowEditorPlacementPreview;
        /* 0x1E88 */ public int MaxNumDebugMessages;
        /* 0x1E8C */ public bool PreloadToolbox;
        /* 0x1E90 */ public int DebugTextureSize;
        /* 0x1E94 */ public bool UseProcTextureDebugger;
        /* 0x1E98 */ public int ProceduralModelsShown;
        /* 0x1E9C */ public int ProceduralModelBatchSize;
        /* 0x1EA0 */ public int ProceduralModelFilterMatchretryCount;
        /* 0x1EA4 */ public bool ProceduralModelsDeterministicSequence;
        /* 0x1EA8 */ public int ProceduralModelsThumbnailSize;
        /* 0x1EAC */ public NMSString0x80 DebugFont;
        /* 0x1F2C */ public NMSString0x80 DebugFontTexture;
        /* 0x1FAC */ public NMSString0x80 CursorTexture;
        /* 0x202C */ public NMSString0x80 PauseTexture;
        /* 0x20AC */ public NMSString0x80 PlayTexture;
        /* 0x212C */ public NMSString0x80 StepTexture;
        /* 0x21AC */ public NMSString0x80 RenderToTexture;
        /* 0x222C */ public bool HmdEnable;
        /* 0x2230 */ public int HmdPreviewScale;
        /* 0x2234 */ public bool HmdTracking;
        /* 0x2235 */ public bool HmdStereoRender;
        /* 0x2236 */ public bool HmdDistortionPassthru;
        /* 0x2238 */ public int HmdMonitor;
        /* 0x223C */ public int HmdEyeBufferWidth;
        /* 0x2240 */ public int HmdEyeBufferHeight;
        /* 0x2244 */ public float HmdEyeScalePos;
        /* 0x2248 */ public float HmdHeadScalePos;
        /* 0x224C */ public bool HmdFrameShiftEnabled;
        /* 0x224D */ public bool HmdUseSolidGuiPointer;
        /* 0x224E */ public bool BodyTurning;
        /* 0x2250 */ public float HmdImmersionFactor;
        /* 0x2254 */ public bool ShowHmdHandControllers;
        /* 0x2255 */ public bool ShowTeleportEffectLocally;
        /* 0x2256 */ public bool DisableLeftHand;
        /* 0x2257 */ public bool DisableHeadConstraints;
        /* 0x2258 */ public bool EnablePhotomodeVR;
        /* 0x2259 */ public bool AllowNGuiVR;
        /* 0x225A */ public bool ForceExtremeWeather;
        /* 0x225B */ public bool ForceExtremeSentinels;
        /* 0x225C */ public bool ForceStarType;
        /* 0x225D */ public bool ForceLoadAllWeather;
        /* 0x2260 */ public GcGalaxyStarTypes ForceStarTypeTo;
        /* 0x2264 */ public bool ForceBiome;
        /* 0x2268 */ public GcBiomeType ForceBiomeTo;
        /* 0x226C */ public bool ForceScreenFilter;
        /* 0x2270 */ public GcScreenFilters ForceScreenFilterTo;
        /* 0x2274 */ public GcBiomeSubType ForceBiomeSubTypeTo;
        /* 0x2278 */ public bool ForceBuildingRace;
        /* 0x227C */ public GcAlienRace ForceBuildingRaceTo;
        /* 0x2280 */ public bool ForceLifeLevel;
        /* 0x2284 */ public GcPlanetLife ForceLifeLevelTo;
        /* 0x2288 */ public bool ForceCreatureLifeLevel;
        /* 0x2289 */ public bool ForceDefaultCreatureFile;
        /* 0x2290 */ public NMSString0x10 DefaultGroundCreatureTable;
        /* 0x22A0 */ public NMSString0x10 DefaultAirCreatureTable;
        /* 0x22B0 */ public NMSString0x10 DefaultWaterCreatureTable;
        /* 0x22C0 */ public NMSString0x10 DefaultCaveCreatureTable;
        /* 0x22D0 */ public GcPlanetLife ForceCreatureLifeLevelTo;
        /* 0x22D4 */ public GcPlanetLife ForceTerrainSettings;
        /* 0x22D8 */ public bool ForceTerrainType;
        /* 0x22DC */ public TkVoxelGeneratorSettingsTypes ForceTerrainTypeTo;
        /* 0x22E0 */ public bool ForcePrimeTerrain;
        /* 0x22E1 */ public bool ForceBinaryStar;
        /* 0x22E2 */ public bool ForceTernaryStar;
        /* 0x22E4 */ public GcGalaxyStarAnomaly ForceAnomalyTo;
        /* 0x22E8 */ public bool ForcePlanetsToHaveWater;
        /* 0x22EC */ public int ForceWaterObjectFileIndex;
        /* 0x22F0 */ public int ForceSkyColourIndex;
        /* 0x22F4 */ public int ForceWaterColourIndex;
        /* 0x22F8 */ public int ForceGrassColourIndex;
        /* 0x22FC */ public bool ModifyPlanetsInInitialSystems;
        /* 0x22FD */ public bool ForcePlanetsToHaveNoWater;
        /* 0x22FE */ public bool ForcePlanetsToHaveNoCaves;
        /* 0x22FF */ public bool ForcePlanetsToHaveNoNoiseLayers;
        /* 0x2300 */ public bool ForcePlanetsToHaveNoTerrainFeatures;
        /* 0x2301 */ public bool DisableLimits;
        /* 0x2302 */ public bool LimitPerRegionInstances;
        /* 0x2303 */ public bool LimitPerRegionBodies;
        /* 0x2304 */ public bool LimitGlobalInstances;
        /* 0x2305 */ public bool LimitGlobalBodies;
        /* 0x2308 */ public int GenerateFarLodBuildingDist;
        /* 0x230C */ public bool DeferRegionBodies;
        /* 0x2310 */ public float GenerateCostDistance;
        /* 0x2314 */ public float GenerateCostAngle;
        /* 0x2318 */ public float GenerateCostLOD;
        /* 0x231C */ public float GenerateCostWait;
        /* 0x2320 */ public bool DChecksEnabled;
        /* 0x2321 */ public bool DChecksOutputJson;
        /* 0x2322 */ public bool DChecksOutputBinary;
        /* 0x2323 */ public bool DChecksOutputFileLine;
        /* 0x2324 */ public int FrameFlipRateDefault;
        /* 0x2328 */ public int FrameFlipRateLoad;
        /* 0x232C */ public int FrameFlipRateGame;
        /* 0x2330 */ public float MaxFrameRate;
        /* 0x2334 */ public bool DisableBaseBuilding;
        /* 0x2335 */ public bool DisableBaseBuildingLimits;
        /* 0x2336 */ public bool AllowGlobalPartSnapping;
        /* 0x2338 */ public float BaseDownloadTimeout;
        /* 0x233C */ public bool DisableBasePowerRequirements;
        /* 0x233D */ public bool EnableBaseMovingOption;
        /* 0x2340 */ public int MoveBaseIndex;
        /* 0x2344 */ public NMSString0x20 AutomaticPartSpawnID;
        /* 0x2364 */ public GcBaseBuildingPartStyle AutomaticPartSpawnStyle;
        /* 0x2368 */ public bool AutomaticPartSpawnInactive;
        /* 0x236C */ public int ProfilerPartIndexPhase;
        /* 0x2370 */ public int ProfilerPartIndexStride;
        /* 0x2374 */ public int ProfilerPartIteration;
        /* 0x2378 */ public bool BaseAdmin;
        /* 0x2379 */ public NMSString0x20 BaseServerPlatform;       // "pc"
        /* 0x239C */ public uint BasePayloadMultiplier;
        /* 0x23A0 */ public bool CrossPlatformFeaturedBases;
        /* 0x23A1 */ public bool ShowMissionIdInTitle;
        /* 0x23A4 */ public TkGlobals ToolkitGlobals;
    }
}
