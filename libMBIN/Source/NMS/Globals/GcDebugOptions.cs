...
{
    [NMS(GUID = 0xE86881CD44E90057, NameHash = 0x13FED27DF728C38)]
    public class GcDebugOptions : NMSTemplate
    {
        ...
        /* 0x0F4A */ public NMSString0x80 PipelineFilePS4;
        /* 0x0FCA */ public NMSString0x80 PipelineFileXboxOne;
        /* 0x104A */ public NMSString0x80 PipelineFileVR;
        /* 0x10CA */ public NMSString0x80 PipelineFileVRPS4;
        /* 0x114A */ public NMSString0x80 PipelineFileFrontend;
        /* 0x11CA */ public NMSString0x80 PipelineFileEditor;
        /* 0x124A */ public NMSString0x80 PipelineFileSwitch;
        /* 0x12CA */ public bool RenderLowFramerate;
        /* 0x12CB */ public bool EnableComputePost;
        /* 0x12CC */ public bool EnableEvenOddRender;
        /* 0x12CD */ public bool MinGPUMode;
        /* 0x12CE */ public bool Proto2DevKit;
        /* 0x12CF */ public bool AlwaysIncludeLocalPlayerInChatMessage;
        /* 0x12D0 */ public bool SimulateNoNetworkConnection;
        // size: 0x3
        ...
        /* 0x12D4 */ public ProxyTypeEnum ProxyType;
        /* 0x12D8 */ public NMSString0x80 ProxyURI;
        // size: 0x8
        ...
        /* 0x1358 */ public ServerEnvEnum ServerEnv;
        /* 0x135C */ public NMSString0x80 AuthBaseUrl;
        /* 0x13DC */ public bool CertificateSecurityBypass;
        /* 0x13DD */ public NMSString0x20 OverrideUsernameForDev;
        /* 0x1400 */ public int DiscoveryAutoSyncIntervalSeconds;
        /* 0x1404 */ public bool DisableSpaceStationSpawnOnJoin;
        /* 0x1405 */ public bool AutoJoinUserEnabled;
        /* 0x1406 */ public NMSString0x800 AutoJoinUserNames;
        /* 0x1C06 */ public bool AlwaysSaveGameAsClient;
        /* 0x1C07 */ public bool DisableMonumentDownloads;
        /* 0x1C08 */ public bool UsePadOnUnfocusedWindow;
        /* 0x1C0C */ public int OverrideMatchmakingVersion;
        /* 0x1C10 */ public NMSString0x200 LoadToBase;
        /* 0x1E10 */ public bool IgnoreTransactionTimeouts;
        /* 0x1E11 */ public bool AutoJoinRandomGames;
        /* 0x1E12 */ public NMSString0x100 GOGLogin;
        /* 0x1F12 */ public bool RecordNetworkStatsOnBoot;
        /* 0x1F13 */ public bool FakeHandsInMultiplayer;
        /* 0x1F14 */ public bool ForceSmallLobby;
        /* 0x1F15 */ public bool ForceTinyLobby;
        /* 0x1F18 */ public int OverrideServerSeasonNumber;
        /* 0x1F1C */ public int OverrideServerSeasonEndTime;
        /* 0x1F20 */ public bool EnableSynergy;
        /* 0x1F21 */ public NMSString0x20 SynergyServer;
        /* 0x1F44 */ public int SynergyPort;
        /* 0x1F48 */ public bool ShowEditorPlacementPreview;
        /* 0x1F4C */ public int MaxNumDebugMessages;
        /* 0x1F50 */ public bool PreloadToolbox;
        /* 0x1F54 */ public int DebugTextureSize;
        /* 0x1F58 */ public bool UseProcTextureDebugger;
        /* 0x1F5C */ public int ProceduralModelsShown;
        /* 0x1F60 */ public int ProceduralModelBatchSize;
        /* 0x1F64 */ public int ProceduralModelFilterMatchretryCount;
        /* 0x1F68 */ public bool ProceduralModelsDeterministicSequence;
        /* 0x1F6C */ public int ProceduralModelsThumbnailSize;
        /* 0x1F70 */ public NMSString0x80 DebugFont;
        /* 0x1FF0 */ public NMSString0x80 DebugFontTexture;
        /* 0x2070 */ public NMSString0x80 CursorTexture;
        /* 0x20F0 */ public NMSString0x80 PauseTexture;
        /* 0x2170 */ public NMSString0x80 PlayTexture;
        /* 0x21F0 */ public NMSString0x80 StepTexture;
        /* 0x2270 */ public NMSString0x80 RenderToTexture;
        /* 0x22F0 */ public bool HmdEnable;
        /* 0x22F4 */ public int HmdPreviewScale;
        /* 0x22F8 */ public bool HmdTracking;
        /* 0x22F9 */ public bool HmdStereoRender;
        /* 0x22FA */ public bool HmdDistortionPassthru;
        /* 0x22FC */ public int HmdMonitor;
        /* 0x2300 */ public int HmdEyeBufferWidth;
        /* 0x2304 */ public int HmdEyeBufferHeight;
        /* 0x2308 */ public float HmdEyeScalePos;
        /* 0x230C */ public float HmdHeadScalePos;
        /* 0x2310 */ public bool HmdFrameShiftEnabled;
        /* 0x2311 */ public bool HmdUseSolidGuiPointer;
        /* 0x2312 */ public bool BodyTurning;
        /* 0x2314 */ public float HmdImmersionFactor;
        /* 0x2318 */ public bool ShowHmdHandControllers;
        /* 0x2319 */ public bool ShowTeleportEffectLocally;
        /* 0x231A */ public bool DisableLeftHand;
        /* 0x231B */ public bool DisableHeadConstraints;
        /* 0x231C */ public bool EnablePhotomodeVR;
        /* 0x231D */ public bool AllowNGuiVR;
        /* 0x231E */ public bool ForceExtremeWeather;
        /* 0x231F */ public bool ForceExtremeSentinels;
        /* 0x2320 */ public bool ForceCorruptSentinels;
        /* 0x2321 */ public bool ForceStarType;
        /* 0x2322 */ public bool ForceLoadAllWeather;
        /* 0x2324 */ public GcGalaxyStarTypes ForceStarTypeTo;
        /* 0x2328 */ public bool ForceBiome;
        /* 0x232C */ public GcBiomeType ForceBiomeTo;
        /* 0x2330 */ public bool ForceScreenFilter;
        /* 0x2334 */ public GcScreenFilters ForceScreenFilterTo;
        /* 0x2338 */ public GcBiomeSubType ForceBiomeSubTypeTo;
        /* 0x233C */ public bool ForceBuildingRace;
        /* 0x2340 */ public GcAlienRace ForceBuildingRaceTo;
        /* 0x2344 */ public bool ForceLifeLevel;
        /* 0x2348 */ public GcPlanetLife ForceLifeLevelTo;
        /* 0x234C */ public bool ForceCreatureLifeLevel;
        /* 0x234D */ public bool ForceDefaultCreatureFile;
        /* 0x2350 */ public NMSString0x10 DefaultGroundCreatureTable;
        /* 0x2360 */ public NMSString0x10 DefaultAirCreatureTable;
        /* 0x2370 */ public NMSString0x10 DefaultWaterCreatureTable;
        /* 0x2380 */ public NMSString0x10 DefaultCaveCreatureTable;
        /* 0x2390 */ public GcPlanetLife ForceCreatureLifeLevelTo;
        /* 0x2394 */ public GcPlanetLife ForceTerrainSettings;
        /* 0x2398 */ public bool ForceTerrainType;
        /* 0x239C */ public TkVoxelGeneratorSettingsTypes ForceTerrainTypeTo;
        /* 0x23A0 */ public bool ForcePirateSystem;
        /* 0x23A1 */ public bool ForcePrimeTerrain;
        /* 0x23A2 */ public bool ForceBinaryStar;
        /* 0x23A3 */ public bool ForceTernaryStar;
        /* 0x23A4 */ public GcGalaxyStarAnomaly ForceAnomalyTo;
        /* 0x23A8 */ public bool ForcePlanetsToHaveWater;
        /* 0x23AC */ public int ForceWaterObjectFileIndex;
        /* 0x23B0 */ public int ForceSkyColourIndex;
        /* 0x23B4 */ public int ForceSpaceSkyColourIndex;
        /* 0x23B8 */ public bool ForceSpaceSkyColourRare;
        /* 0x23BC */ public int ForceWaterColourIndex;
        /* 0x23C0 */ public int ForceGrassColourIndex;
        /* 0x23C4 */ public bool ModifyPlanetsInInitialSystems;
        /* 0x23C5 */ public bool ForcePlanetsToHaveNoWater;
        /* 0x23C6 */ public bool ForcePlanetsToHaveNoCaves;
        /* 0x23C7 */ public bool ForcePlanetsToHaveNoNoiseLayers;
        /* 0x23C8 */ public bool ForcePlanetsToHaveNoTerrainFeatures;
        /* 0x23C9 */ public bool ForceRareAsteroidSystem;
        /* 0x23CC */ public int ForceAsteroidSystemIndex;
        /* 0x23D0 */ public bool DisableLimits;
        /* 0x23D1 */ public bool LimitPerRegionInstances;
        /* 0x23D2 */ public bool LimitPerRegionBodies;
        /* 0x23D3 */ public bool LimitGlobalInstances;
        /* 0x23D4 */ public bool LimitGlobalBodies;
        /* 0x23D8 */ public int GenerateFarLodBuildingDist;
        /* 0x23DC */ public bool DeferRegionBodies;
        /* 0x23E0 */ public float GenerateCostDistance;
        /* 0x23E4 */ public float GenerateCostAngle;
        /* 0x23E8 */ public float GenerateCostLOD;
        /* 0x23EC */ public float GenerateCostWait;
        /* 0x23F0 */ public bool DChecksEnabled;
        /* 0x23F1 */ public bool DChecksOutputJson;
        /* 0x23F2 */ public bool DChecksOutputBinary;
        /* 0x23F3 */ public bool DChecksOutputFileLine;
        /* 0x23F4 */ public int FrameFlipRateDefault;
        /* 0x23F8 */ public int FrameFlipRateLoad;
        /* 0x23FC */ public int FrameFlipRateGame;
        /* 0x2400 */ public float MaxFrameRate;
        /* 0x2404 */ public bool DisableBaseBuilding;
        /* 0x2405 */ public bool DisableBaseBuildingLimits;
        /* 0x2406 */ public bool AllowGlobalPartSnapping;
        /* 0x2408 */ public float BaseDownloadTimeout;
        /* 0x240C */ public bool DisableBasePowerRequirements;
        /* 0x240D */ public bool EnableBaseMovingOption;
        /* 0x2410 */ public int MoveBaseIndex;
        /* 0x2414 */ public NMSString0x20 AutomaticPartSpawnID;
        /* 0x2434 */ public GcBaseBuildingPartStyle AutomaticPartSpawnStyle;
        /* 0x2438 */ public bool AutomaticPartSpawnInactive;
        /* 0x243C */ public int ProfilerPartIndexPhase;
        /* 0x2440 */ public int ProfilerPartIndexStride;
        /* 0x2444 */ public int ProfilerPartIteration;
        /* 0x2448 */ public bool BaseAdmin;
        /* 0x2449 */ public NMSString0x20 BaseServerPlatform;
        /* 0x246C */ public uint BasePayloadMultiplier;
        /* 0x2470 */ public bool CrossPlatformFeaturedBases;
        /* 0x2471 */ public bool ShowMissionIdInTitle;
        /* 0x2474 */ public TkGlobals ToolkitGlobals;
        /* 0x26A4 */ public bool AllowOverrideSettlementOwnership;
        /* 0x26A5 */ public NMSString0x40 OverrideSettlementOwnershipUsername;
        /* 0x26E5 */ public NMSString0x40 OverrideSettlementOwnershipOnlineId;
        /* 0x2725 */ public bool BlockSettlementsNetwork;
        /* 0x2726 */ public bool EnableAccessibleUI;
        /* 0x2727 */ public bool DisablePartialStories;
        /* 0x2728 */ public bool UnlockAllStories;
        /* 0x2729 */ public bool UnlockAllWords;
    }
}
