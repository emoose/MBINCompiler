...
{
    [NMS(Size = 0x1180, GUID = 0x3DDBA834D19869B0)]
    public class GcAISpaceshipGlobals : NMSTemplate
    {
        ...
        /* 0x3F0 */ public int SpaceBattleLevel;
        ...
        /* 0x568 */ public int MaxNumTurretMissiles;
        /* 0x56C */ public float TurretOriginOffset;
        /* 0x570 */ public float TurretAlertLightIntensity;
        ...
        /* 0x5A0 */ public float AttackFreighterApproachDistance;
        ...
        /* 0x974 */ public float FreighterAttackDisengageDistance;
        ...
        /* 0x9F8 */ public float TurretRandomOffset;
        /* 0x9FC */ public float TurretRandomAIShipOffset;
        /* 0xA00 */ public float PoliceLaunchDistance;
        /* 0xA04 */ public float Scaler;
        /* 0xA08 */ public float ScaleTime;
        /* 0xA0C */ public float ScalerMinDist;
        /* 0xA10 */ public float ScalerMaxDist;
        /* 0xA14 */ public float ScaleHeightMin;
        /* 0xA18 */ public float ScaleHeightMax;
        /* 0xA1C */ public bool ScaleDisabledWhenOnFreighter;
        /* 0xA20 */ public float WarpInPlayerLocatorTime;
        /* 0xA24 */ public float WarpInPlayerLocatorMinOffset;
        /* 0xA28 */ public float WarpInTime;
        /* 0xA2C */ public float WarpFadeInTime;
        /* 0xA30 */ public float WarpInTimeFreighter;
        /* 0xA34 */ public TkCurveType WarpInCurve;
        /* 0xA38 */ public float WarpInVariance;
        /* 0xA3C */ public float WarpInDistance;
        /* 0xA40 */ public float WarpInPostSpeed;
        /* 0xA44 */ public float WarpInPostSpeedFreighter;
        /* 0xA48 */ public float WarpInAudioFXDelay;
        /* 0xA4C */ public float WarpOutDistance;
        /* 0xA50 */ public float PirateFlybyLength;
        /* 0xA54 */ public float FlybyLength;
        /* 0xA58 */ public float FlybyHeight;
        /* 0xA5C */ public float FlybyOffset;
        /* 0xA60 */ public GcProjectileLineData ShipBullet;
        /* 0xA88 */ public GcSpaceshipTravelData TraderTravel;
        /* 0xAE8 */ public float WingmanLockDistance;
        /* 0xAEC */ public float WingmanLockBetweenTime;
        /* 0xAF0 */ public float WingmanLockArriveTime;
        /* 0xAF4 */ public float WingmanMinHeight;
        /* 0xAF8 */ public float WingmanHeightAdjust;
        /* 0xAFC */ public float WingmanStartTime;
        /* 0xB00 */ public float WingmanOffsetStart;
        /* 0xB04 */ public float WingmanOffset;
        /* 0xB08 */ public float WingmanSideOffset;
        /* 0xB0C */ public float WingmanRotate;
        /* 0xB10 */ public float WingmanAtTime;
        /* 0xB14 */ public float WingmanAtTimeBack;
        /* 0xB18 */ public float WingmanPerpTime;
        /* 0xB1C */ public float WingmanVelocityBand;
        /* 0xB20 */ public float WingmanVelocityBandForce;
        /* 0xB24 */ public float TraderAtTime;
        /* 0xB28 */ public float TraderAtTimeBack;
        /* 0xB2C */ public float TraderPerpTime;
        /* 0xB30 */ public float TraderVelocityBand;
        /* 0xB34 */ public float TraderVelocityBandForce;
        /* 0xB38 */ public float WingmanAlign;
        /* 0xB3C */ public float WarpSpeed;
        /* 0xB40 */ public float WarpForce;
        /* 0xB44 */ public float TrailSpeedFadeMinSpeed;
        /* 0xB48 */ public float TrailSpeedFadeFalloff;
        /* 0xB4C */ public float DockingLandingTime;
        /* 0xB50 */ public float DockingLandingTimeDirectional;
        /* 0xB54 */ public float DockingSpringTime;
        /* 0xB58 */ public float DockingLandingBounceTime;
        /* 0xB5C */ public float DockingLandingBounceHeight;
        /* 0xB60 */ public float DockingRotateStartTime;
        /* 0xB64 */ public float DockingRotateSpeed;
        /* 0xB68 */ public float DockWaitMinTime;
        /* 0xB6C */ public float DockWaitMaxTime;
        /* 0xB70 */ public float TakeOffHoverPointReachedDistance;
        /* 0xB74 */ public float TakeOffExitHeightOffset;
        /* 0xB78 */ public float TakeOffExtraAIHeight;
        /* 0xB7C */ public float LandingManuevreTime;
        /* 0xB80 */ public float LandingManeuvreAlignTime;
        /* 0xB84 */ public float LandingHoverPointReachedDistance;
        /* 0xB88 */ public float LandingDirectionalHoverPointReachedDistance;
        /* 0xB8C */ public float AtmosphereTerminalSpeed;
        /* 0xB90 */ public float CircleApproachDistance;
        /* 0xB94 */ public float TravelMinBoostTime;
        /* 0xB98 */ public float GroundCircleHeight;
        /* 0xB9C */ public float GroundCircleHeightMax;
        /* 0xBA0 */ public float OrbitHeight;
        /* 0xBA4 */ public float AtmosphereEffectMin;
        /* 0xBA8 */ public float AtmosphereEffectMax;
        /* 0xBAC */ public float MaxTorque;
        /* 0xBB0 */ public float ShipAngularFactor;
        /* 0xBB4 */ public float RollAmount;
        /* 0xBB8 */ public float RollMinTurnAngle;
        /* 0xBBC */ public float FinalDeathExplosionScale;
        /* 0xBC0 */ public float FinalDeathExplosionTime;
        /* 0xBC4 */ public GcShipAIDeathData Death;
        /* 0xBE0 */ public GcShipAIAttackData AttackPlanet;
        /* 0xCB0 */ public GcShipAIAttackData TraderAttack;
        /* 0xD80 */ public GcShipAIPlanetPatrolData WingmanPathData;
        [NMS(Size = 0x4)]
        /* 0xDC0 */ public GcAIShipDebugSpawnData[] DebugShipSpawns;
    }
}
