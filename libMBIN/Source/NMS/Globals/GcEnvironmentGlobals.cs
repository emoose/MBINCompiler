...
namespace libMBIN.NMS.Globals
{
    ...
    public class GcEnvironmentGlobals : NMSTemplate
    {
        ...
        /* 0x398 */ public float CameraLocationStableTime;
        /* 0x39C */ public float AsteroidFieldStableEnterTime;
        /* 0x3A0 */ public float AsteroidFieldStableLeaveTime;
        /* 0x3A4 */ public float TemperatureSmoothTime;
        /* 0x3A8 */ public float SunFactorMin;
        /* 0x3AC */ public float ExposureSurfaceContrib;
        /* 0x3B0 */ public float ExposureSurfaceDistMax;
        /* 0x3B4 */ public float ExposureGroundFactorAddMul;
        /* 0x3B8 */ public Vector2f ExposureHeightBracket;
        /* 0x3C0 */ public float DailyTempChangePercent;
        /* 0x3C4 */ public float SpaceTemperature;
        /* 0x3C8 */ public float AbandonedFreighterMinTemperature;
        /* 0x3CC */ public float AbandonedFreighterMaxTemperature;
        /* 0x3D0 */ public float ShipTemperature;
        /* 0x3D4 */ public float SpaceRadiation;
        /* 0x3D8 */ public float ShipRadiation;
        /* 0x3DC */ public float SpaceToxicity;
        /* 0x3E0 */ public float ShipToxicity;
        /* 0x3E4 */ public bool MatchPlantPalettes;
        /* 0x3E8 */ public float DuplicateColourThreshold;
        // size: 0x3
        ...
        /* 0x3EC */ public SwitchTypeEnum SwitchType;
        /* 0x3F0 */ public float GrassNormalUpright;
        /* 0x3F4 */ public float GrassNormalOffset;
        /* 0x3F8 */ public float GrassNormalSpherify;
        /* 0x3FC */ public float GrassNormalMap;
        /* 0x400 */ public float MinPlacementBlendValue;
        /* 0x404 */ public float MinPlacementBlendValuePatch;
        /* 0x408 */ public float MaxPlacementBlendValuePatch;
        /* 0x40C */ public float MinPlacementObjectScale;
        /* 0x410 */ public float SpaceStationStateBoundingBoxScaler;
        /* 0x414 */ public float AtmosphereSpaceRadius;
        /* 0x418 */ public float SpawnLowerAtmosphereRadiusMultiplier;
        /* 0x41C */ public float TerrainFadeTime;
        /* 0x420 */ public float TerrainFadeTimeInShip;
        /* 0x424 */ public float CreatureFadeTime;
        /* 0x428 */ public float FloraFadeTimeMin;
        /* 0x42C */ public float FloraFadeTimeMax;
        /* 0x430 */ public float PlanetUnwrapMin;
        /* 0x434 */ public float PlanetUnwrapMax;
        /* 0x438 */ public float TerrainFlattenMin;
        /* 0x43C */ public float TerrainFlattenMax;
        /* 0x440 */ public float HeightFogHeightMin;
        /* 0x444 */ public float WaterFogHeightMax;
        /* 0x448 */ public float WaterAlphaHeightMin;
        /* 0x44C */ public float WaterAlphaHeightMax;
        /* 0x450 */ public float DoFHeightMin;
        /* 0x454 */ public float DoFHeightMax;
        /* 0x458 */ public float SunClampHeightMin;
        /* 0x45C */ public float SunClampHeightMax;
        /* 0x460 */ public float HeavyAirFadeDistance;
        /* 0x464 */ public float HeavyAirFadeInTime;
        /* 0x468 */ public float HeavyAirFadeOutTime;
        /* 0x46C */ public float PlanetFlipDistance;
        /* 0x470 */ public float PlanetEffectEndDistance;
        /* 0x474 */ public float AsteroidFadeHeightMin;
        /* 0x478 */ public float AsteroidFadeHeightMax;
        /* 0x47C */ public float AsteroidScale;
        /* 0x480 */ public float SmallAsteroidScale;
        /* 0x484 */ public float AsteroidMinRotate;
        /* 0x488 */ public float AsteroidMaxRotate;
        /* 0x48C */ public float MinWaterReflections;
