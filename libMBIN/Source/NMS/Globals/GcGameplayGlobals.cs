...
{
    [NMS(GUID = 0x54A2C0A704042354, NameHash = 0x71CAF682B6986E6E)]
    public class GcGameplayGlobals : NMSTemplate
    {
        ...
        /* 0x269C */ public int RocketLockerFuelUse;
        /* 0x26A0 */ public bool EnableTechPackaging;
        /* 0x26A4 */ public float CargoShieldStrength;
        /* 0x26A8 */ public float TechDamageChanceShielded;
        /* 0x26AC */ public float TechDamageChanceToSelectPrimary;
        /* 0x26B0 */ public float PirateRaidAccelerator;
        /* 0x26B4 */ public float PirateGroundAccelerator;
        /* 0x26B8 */ public float PirateGroundInventoryAccelerator;
        /* 0x26BC */ public float PoliceAcceleratorStationLockOn;
        /* 0x26C0 */ public float PoliceAcceleratorPulseExtra;
        /* 0x26C4 */ public int PoliceAcceleratorSmugglingItemsMax;
        /* 0x26C8 */ public float PoliceAcceleratorSmugglingMulMax;
        /* 0x26CC */ public float PoliceAcceleratorNoCargoWealthy;
        /* 0x26D0 */ public float PoliceAcceleratorNoCargoNormal;
        /* 0x26D4 */ public float PoliceAcceleratorNoCargoSkipScanOdds;
        /* 0x26D8 */ public float ShipInterestAcceleratorInAsteroidField;
        /* 0x26DC */ public float InfestedPlanetDeepSpaceFlybyMultiplier;
        /* 0x26E0 */ public float SmugglerSellingMarkup;
        /* 0x26E4 */ public float IllegalTechProductTradingMod;
        /* 0x26E8 */ public float CombatLevelBestWeaponBias;
        /* 0x26EC */ public float CombatLevelBaseValueBoltcaster;
        /* 0x26F0 */ public float CombatLevelBaseValueShotgun;
        /* 0x26F4 */ public float CombatLevelBaseValueRailgun;
        /* 0x26F8 */ public float CombatLevelBaseValueSMG;
        /* 0x26FC */ public float CombatLevelBaseValueCannon;
        /* 0x2700 */ public float CombatLevelBaseValueGrenade;
        /* 0x2704 */ public float CombatLevelSClassValue;
        /* 0x2708 */ public NMSString0x10 NexusRecipeCostType;
        /* 0x2718 */ public int NexusRecipeCostNaniteMultiplier;
        /* 0x271C */ public float ShipScanPlanetRechargeMultiplier;
        /* 0x2720 */ public float ShipScanSpaceRechargeMultiplier;
        /* 0x2728 */ public NMSString0x10 FreeSuitSlotID;
        /* 0x2738 */ public float InitialLocationProtectionRadiusMultiplier;
        /* 0x273C */ public float PartyPlanetSearchDistance;
        /* 0x2740 */ public float UnderwaterLightningDamageDistanceMultiplier;
        /* 0x2744 */ public int MaxActiveWeatherHazardGifts;
        /* 0x2748 */ public float WeatherHazardGiftMaxDistance;
        /* 0x274C */ public float WeatherHazardGiftLifeTime;
        /* 0x2750 */ public GcTechnologyCategory TechnologyOverrideForSmuggler;
        /* 0x2754 */ public float MaxMeteorSurfaceAngle;
        /* 0x2758 */ public float StormGravityChangeTime;
        /* 0x275C */ public float StormBonusJetpackMod;
        /* 0x2760 */ public float StormBonusSprintMod;
        /* 0x2764 */ public float StormBonusMiningHeatMod;
        /* 0x2768 */ public float StormBonusMiningAmountMod;
        /* 0x276C */ public GcPlayerHazardType StormBonusJetpackWeather;
        /* 0x2770 */ public GcPlayerHazardType StormBonusSprintWeather;
        /* 0x2774 */ public GcPlayerHazardType StormBonusMiningHeatWeather;
        /* 0x2778 */ public GcPlayerHazardType StormBonusMiningAmountWeather;
        /* 0x277C */ public float AlienPodThreshold2;
        /* 0x2780 */ public float AlienPodThreshold1;
