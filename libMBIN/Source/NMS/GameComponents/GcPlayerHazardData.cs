...
{
    [NMSDescription(@"A class to define various environmental hazard damage and effects on the player.
    ...
    public class GcPlayerHazardData : NMSTemplate
    {
        ...
        [NMSDescription(@"*x component*: Time in seconds to deplete an amount of 100 protection charges below TriggerValue.
