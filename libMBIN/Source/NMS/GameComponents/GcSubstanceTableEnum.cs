...
{
    [NMS(Size = 0x4, GUID = 0x41110DD7AFE909CC, NameHash = 0x2A7FC25DED2C3BE5)]
    public class GcSubstanceTableEnum : NMSTemplate
    {
        ...
        public enum SubstanceEnum {
            ...
            PLANT_WATER, PLANT_POOP, SPACEGUNK1, SPACEGUNK2, SPACEGUNK3, SPACEGUNK4, SPACEGUNK5, SPECIAL_POOP, TECHFRAG_R, QUICKSILVER,
            UNITS, TRA_STANDING_UP, TRA_STANDING_DN, EXP_STANDING_UP, EXP_STANDING_DN, WAR_STANDING_UP, WAR_STANDING_DN, TGUILD_STAND_UP, TGUILD_STAND_DN, EGUILD_STAND_UP,
            EGUILD_STAND_DN, WGUILD_STAND_UP, WGUILD_STAND_DN, SUNGOLD, SOULFRAG
        }
