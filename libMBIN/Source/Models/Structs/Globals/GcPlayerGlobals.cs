namespace libMBIN.Models.Structs
{
    public class GcPlayerGlobals : NMSTemplate
    {
        ...
        /* 0xDC */ public float VehicleRaceResultsHintTime;
        /* 0xE0 */ public float OtherPlayerTrackArrowRange;
        /* 0xE4 */ public float WantedLevelPlayerRange;
        /* 0xE8 */ public float WantedLevelPlayerRangeSpace;
        /* 0xEC */ public float PlayerTransferRange;
        /* 0xF0 */ public float PlayerSpaceTransferRange;
        /* 0xF4 */ public float DroneScanTimeToForget;
        /* 0xF8 */ public float GhostbusterStartLength;
        /* 0xFC */ public float GhostbusterStart1;
        /* 0x100 */ public float GhostbusterSpeed1;
        /* 0x104 */ public float GhostbusterFreq1;
        /* 0x108 */ public float GhostbusterAmp1;
        /* 0x10C */ public float GhostbusterStart2;
        /* 0x110 */ public float GhostbusterSpeed2;
        /* 0x114 */ public float GhostbusterFreq2;
        /* 0x118 */ public float GhostbusterAmp2;
        /* 0x11C */ public float GhostbusterStart3;
        /* 0x120 */ public float GhostbusterSpeed3;
        /* 0x124 */ public float GhostbusterFreq3;
        /* 0x128 */ public float GhostbusterAmp3;
        /* 0x12C */ public bool WeaponZoomEnabled;
        /* 0x130 */ public float WeaponZoomFOV;
        /* 0x134 */ public float WeaponZoomRecoilMultiplier;
        /* 0x138 */ public float WeaponZoomVertRotation;
        /* 0x13C */ public float WeaponZoomHorzRotation;
        /* 0x140 */ public bool FrontShieldEnabled;
        /* 0x144 */ public float FrontShieldOffsetOff;
        /* 0x148 */ public float FrontShieldOffsetOn;
        /* 0x14C */ public float FrontShieldSpeedSlowdown;
        /* 0x150 */ public float CombatSpawnMinWantedTime;
        /* 0x154 */ public float ExperienceHardPiratesDamagePotentialMin;
        /* 0x158 */ public float ExperienceHardPiratesDamagePotentialRange;
        /* 0x15C */ public float ExperienceHardPiratesDamageMaxOdds;
        /* 0x160 */ public float ExperienceMediumPiratesDamagePotentialMin;
        /* 0x164 */ public float ExperienceMediumPiratesDamagePotentialRange;
        /* 0x168 */ public float ExperienceMediumPiratesDamageMaxOdds;
        /* 0x16C */ public float CommunicatorSpeed;
        /* 0x170 */ public float GrenadeBounceDamping;
        /* 0x174 */ public float GrenadeBounceMaxSpeed;
        /* 0x178 */ public float GrenadeStopExplodeTime;
        /* 0x17C */ public float CockpitEjectTestSphereRadius;
        /* 0x180 */ public float CockpitEjectTestSphereRange;
        /* 0x184 */ public float CockpitEjectSideTestRange;
        /* 0x188 */ public float WeaponShotgunSlowdown;
        /* 0x18C */ public int MouseSmoothMode;
        /* 0x190 */ public Vector2f MouseSpringStrength;
        /* 0x198 */ public Vector2f MouseSpringStrengthMinDelta;
        /* 0x1A0 */ public Vector2f MouseSpringStrengthMaxDelta;
        /* 0x1A8 */ public float HardModeEnergyDischargeRateLow;
        /* 0x1AC */ public float HardModeEnergyDischargeRateMedium;
        /* 0x1B0 */ public float HardModeEnergyDischargeRateHigh;
        /* 0x1B4 */ public float HazardDamageMinTime;
        /* 0x1B8 */ public float EnergyDamageMinTime;
        /* 0x1BC */ public float EnergyDischargeRateLow;
        /* 0x1C0 */ public float EnergyDischargeRateMedium;
        /* 0x1C4 */ public float EnergyDischargeRateHigh;
        /* 0x1C8 */ public float EnergyDischargeRateFloatingInSpace;
        /* 0x1CC */ public float EnergyPainRate;
        /* 0x1D0 */ public float SolarRegenFactor;
        [NMS(Size = 0xC, Ignore = true)]
        ...
        /* 0x278 */ public float JetpackUpForceDeadPlanetExtra;
        /* 0x27C */ public float JetpackForceDeadPlanetExtra;
        /* 0x280 */ public float JetpackIgnitionForceDeadPlanetExtra;
        /* 0x284 */ public bool EnableHeadMovements;
        /* 0x285 */ public bool ClampPitch;
        /* 0x288 */ public float DamageRepairFactor;
        /* 0x28C */ public float DamageRepairFactorHardMode;
        /* 0x290 */ public float NormalModeHazardTimeMultiplier;
        /* 0x294 */ public float NormalModeHazardDamageRateMultiplier;
        /* 0x298 */ public float NormalModeHazardDamageWoundRateMultiplier;
        /* 0x29C */ public float NormalModeSubstanceRewardMultiplier;
        /* 0x2A0 */ public float NormalModeHazardRechargeUnderground;
        /* 0x2A4 */ public float HardModeHazardTimeMultiplier;
        /* 0x2A8 */ public float HardModeHazardDamageRateMultiplier;
        /* 0x2AC */ public float HardModeHazardDamageWoundRateMultiplier;
        /* 0x2B0 */ public float HardModeSubstanceRewardMultiplier;
        /* 0x2B4 */ public float HardModeHazardRechargeUnderground;
        /* 0x2B8 */ public float FreighterProbeScanTime;
        /* 0x2BC */ public int MaxNumDestroyEffects;
        /* 0x2C0 */ public int MinNumDestroyEffects;
        /* 0x2C4 */ public float ProjectileEndTime;
        /* 0x2C8 */ public float ExplosionTimePerEffect;
        /* 0x2CC */ public float ExplosionTimeVariance;
        /* 0x2D0 */ public float ExplosionScaleVariance;
        /* 0x2D4 */ public float ExplosionBoundingInset;
        /* 0x2D8 */ public float ExplosionBoundingInsetRange;
        /* 0x2DC */ public float DestroyEffectFinalDelay;
        /* 0x2E0 */ public float ShipPriceExp2;
        /* 0x2E4 */ public float WeaponPriceExp2;
        /* 0x2E8 */ public float FreighterPriceExp2;
        /* 0x2EC */ public float ShipCoolFactor;
        /* 0x2F0 */ public float WeaponCoolFactor;
        /* 0x2F4 */ public float FreighterCoolFactor;
        /* 0x2F8 */ public bool MouseCrosshairVisible;
        /* 0x2FC */ public float MouseMaxLength;
        /* 0x300 */ public float MouseDeadZone;
        /* 0x304 */ public float MouseAimZone;
        /* 0x308 */ public float MouseCrosshairMaxAlpha;
        /* 0x30C */ public float MouseCrosshairAlphaFade;
        /* 0x310 */ public float MouseCrosshairAlphaFadeSpeed;
        /* 0x314 */ public float MouseCrosshairLineAlpha;
        /* 0x318 */ public float MouseCrosshairLineWidth;
        /* 0x31C */ public float MouseCrosshairShipStrength;
        /* 0x320 */ public float MouseCrosshairMultiplier;
        /* 0x324 */ public bool UseEnergy;
        /* 0x325 */ public bool InventoryDamage;
        /* 0x326 */ public bool NeverPreyedOn;
        /* 0x327 */ public bool PermanantFire;
        /* 0x328 */ public bool PermanantAltFire;
        /* 0x329 */ public bool LuckyWithTech;
        /* 0x32C */ public int BulletCostReducer;
        /* 0x330 */ public int BulletClipMultiplier;
        /* 0x334 */ public float LootForceMultiplier;
        /* 0x338 */ public float WoundTimeMinimum;
        /* 0x33C */ public float WoundDamageLimit;
        /* 0x340 */ public float WoundDamageLimitShip;
        /* 0x344 */ public float WoundDamageDecayTime;
        /* 0x348 */ public float ResourceBlobFinalScaleDistance;
        /* 0x34C */ public float LaserPlayerOffset;
        /* 0x350 */ public float WalkerAlertRange;
        /* 0x354 */ public float WalkerSightRange;
        /* 0x358 */ public float WalkerSightAngle;
        /* 0x35C */ public float CombatEscalateTime;
        /* 0x360 */ public float CombatEscapeRadius;
        /* 0x364 */ public float CombatEscapeTime;
        /* 0x368 */ public bool UpgradeExosuitWithProduct;
        ...
        /* 0x478 */ public float MeleeDistance;
        /* 0x47C */ public float MeleeDistance3P;
        /* 0x480 */ public float MeleeRadius;
        /* 0x484 */ public float MeleeHitTime;
        /* 0x488 */ public float MeleeSpeedBoost;
        /* 0x48C */ public float MeleeSpeedDamageBoost;
        /* 0x490 */ public float MeleeSpeedBoostRangeMultiplier;
        /* 0x494 */ public float MeleeStaminaDrain;
        /* 0x498 */ public float TemperatureDisplaySampleTime;
        [NMS(Size = 0x4, Ignore = true)]
        /* 0x49C */ public byte[] Padding49C;
